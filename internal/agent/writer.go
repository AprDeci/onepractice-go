...
func NewEssayChatModel(ctx context.Context, cfg llm.ModelConfig) (model.BaseChatModel, error) {
	return llm.NewChatModel(ctx, cfg, llm.WithJSONOutput(), llm.WithMaxTokens(essayMaxOutputTokens))
}
